...
export const SystemHealthPage: React.FC = () => {
  ...
  const liveSensors = [
    ...
    { name: 'Fuel Flow', val: `${telemetry.fuelFlowLh.toFixed(1)} L/h`, hz: '50 Hz', status: 'VALID' },
    { name: 'Battery Volts', val: `${telemetry.batteryVoltage.toFixed(1)} V`, hz: '10 Hz', status: 'VALID' },
